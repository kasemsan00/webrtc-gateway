...
Forces lease ownership to this instance and sends SIP REGISTER.
...
```json
{
  "error": "Failed to register trunk: REGISTER failed: 401 Unauthorized"
}
```
