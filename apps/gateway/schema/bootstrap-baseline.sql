...
-- ============================================================================
-- 9) Client Diagnostics (events not tied to a call session)
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_client_diagnostic_events_ts ON client_diagnostic_events (ts DESC);
CREATE INDEX IF NOT EXISTS idx_client_diagnostic_events_trace_ts ON client_diagnostic_events (client_trace_id, ts DESC) WHERE client_trace_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_client_diagnostic_events_auth_subject_ts ON client_diagnostic_events (auth_subject, ts DESC) WHERE auth_subject IS NOT NULL;
