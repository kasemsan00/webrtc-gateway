...
เอกสารนี้อ้างอิงสถานะโค้ดปัจจุบันของ `webrtc-gateway` และใช้เป็นหลักฐานส่งงาน/ตรวจรับส่วน Gateway โดยไม่บังคับให้ชื่อ message ตรง TOR ทีละตัวหากมีการพัฒนารุ่นใหม่แทนแล้ว